...
<hr>
      ...
      >
        <title id="titleId">Gustavo Rocha's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2023 : 0, Total PRs: 0, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 245.46188480657727;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Gustavo Rocha's GitHub Stats</text>
    </g>
      </g>
